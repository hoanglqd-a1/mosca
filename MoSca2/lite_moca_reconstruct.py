...
def static_reconstruct(ws, log_path, fit_cfg):
    ...
    cams, s2d, _ = moca_solve(
        ...
        # static_id_mode="raft" if s2d.has_epi else ("segment" if s2d.has_segment else "track"),
        static_id_mode="segment" if s2d.has_segment else ("raft" if s2d.has_epi else "track"),
        # * robust setting
    ...
    print("Finish static reconstruct")
    return s2d
