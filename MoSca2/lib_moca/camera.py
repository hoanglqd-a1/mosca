...
class MonocularCameras(nn.Module):
    ...
    def __init__(
        self,
        n_time_steps, # times step
        default_H, # screen height, width
        default_W,
        fxfycxcy: list = None,  # intrinsic parameter, intr init 1, fxfy in deg, cxcy in ratio [53.1, 53.1, 0.5, 0.5], 
        # used if intrinsic matrix is not given
        K=None,  # intrinsic matric, intr init 2, K is 3x3 mat, 
        delta_flag=True, #if True, using T_0, deltaT_01, deltaT_12, ... else T_0, T_1, T_2, ...
