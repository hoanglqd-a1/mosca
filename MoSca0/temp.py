...
if __name__ == "__main__":
    ...
    print("\nTo run this code:")
    print("1. Save it as a Python file (e.g., `png_converter.py`).")
    print("2. Make sure you have Pillow installed: `pip install Pillow`")
    print("3. Run the file from your terminal: `python png_converter.py`")
    print("\nRemember to replace 'my_png_images' with your actual input directory.")
