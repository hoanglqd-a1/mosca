            ...
            if viz_cheap_interval > 0 and (
                ...
                with torch.no_grad():
                    ...
                    if d_flag:
                        ...
                        corr_grad.append(
                            d_model.corr_gradient_accum[neighboring_t_mask]
                            / torch.clamp(d_model.corr_gradient_denom[neighboring_t_mask], min=1e-6)
                        )
