...
def viz2d_flow_video(
    ...
    print("s_traj shape:", s_traj.shape)
    print("choice shape:", choice.shape)
    print("choice dtype:", choice.dtype)
    print("choice device:", choice.device)
    print("s_traj device:", s_traj.device)
    print("choice min:", choice.min().item(), "max:", choice.max().item())
