    ...
    def photometric_fit(
        ...
        if d_flag:
            ...
            optimizer_deformation = torch.optim.Adam(
                d_model.scf.deformation.parameters(), lr=1e-5
            )
            # optimizer_feature = torch.optim.Adam(
            #     [d_model.scf.node_feature], lr=1e-3
            # )
        ...
        d_model.scf.remove_param_node_xyz()
        d_model.scf.update_node_xyz_quat()
